...
当前阶段就业发布四个核心入口：简历制作、简历诊断、全景仿真面试、模拟面试。模拟面试已支持复用目标岗位、简历和个人情况完成文字提问、逐轮回答、结束复盘与历史查看；AI 暂不可用时使用基础问题和基础复盘继续流程。深造只提供考研、保研、留学方向入口，后续接入规划能力。简历微课、数字人面试、真题库和面试微课等能力暂不配置到平台菜单。
