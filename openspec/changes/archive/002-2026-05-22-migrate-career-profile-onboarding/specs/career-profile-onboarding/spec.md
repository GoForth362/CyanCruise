...
The system SHALL expose application-level operations to read a snapshot, merge onboarding, merge preferences, save profile inputs, refresh unified profile, and get unified profile for the current user or a specified user id.
