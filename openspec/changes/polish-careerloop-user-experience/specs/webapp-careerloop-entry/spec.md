...
- **WHEN** 用户或开发者使用 `?ccDebug=1` 打开 CareerLoop webapp
...
- **THEN** 平台菜单 SHALL 打开 `/ierp/isv/v620/careerloop/index.htm#employment-home`
- **AND** 页面 SHALL 展示 AI简历制作、AI简历修改、全景仿真面试、AI模拟面试四个核心入口
- **AND** 就业页 SHALL NOT 与首页共用 `#workbench` 地址

#### Scenario: 平台侧边栏打开深造页
- **WHEN** 用户从金蝶平台侧边栏点击“深造”
- **THEN** 平台菜单 SHALL 打开 `/ierp/isv/v620/careerloop/index.htm#further-study-home`
