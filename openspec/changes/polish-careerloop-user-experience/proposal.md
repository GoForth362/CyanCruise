...
- 将默认首页从“顶部横向导航 + 大块状态摘要”的工程工作台，调整为“左侧分组导航 + 右侧功能卡片矩阵”的功能中心布局，贴近求职产品的使用入口。
- 将“简历”“面试”等能力按业务分组展示，默认进入后能直接看到 AI 简历制作、简历修改、模拟面试、真题练习等高频功能，而不是接口路线或状态面板。
...
- `webapp-careerloop-home-layout`：新增默认首页/功能中心布局规则，定义左侧分组导航、右侧功能卡片矩阵和移动端降级方式。
