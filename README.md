...
CyanCruise 面向求职与升学场景，围绕“认识自己、明确方向、持续行动、获得反馈”构建 CareerLoop 职业成长闭环。项目将用户画像、职业测评、简历、今日任务、模拟面试、反馈与职业计划组织为连贯的业务流程，并探索 AI 智能体在职业规划和个性化建议中的实际应用。

本仓库同时也是一个金蝶云苍穹二次开发工程。项目正在将原 IPD 系统的业务规则、数据语义、流程和接口契约迁移到 Cosmic 平台，而不是直接搬运 Spring Boot、JPA、Flyway、Vue 或 uni-app 实现。
