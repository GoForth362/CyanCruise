...
public class CosmicInterviewStorage implements InterviewStorage {
    ...
    public InterviewSessionDto saveInterview(InterviewSessionDto interview) {
        CosmicDatamodelRecord row = interview.getInterviewId() == null ? null
                : gateway.load(CareerLoopDatamodelObjects.INTERVIEW, interview.getInterviewId());
        if (row == null) {
            row = new CosmicDatamodelRecord(CareerLoopDatamodelObjects.INTERVIEW)
                    .set(CareerLoopDatamodelObjects.CREATED_AT, interview.getStartedAt() == null ? LocalDateTime.now() : interview.getStartedAt());
        }
        row.set(CareerLoopDatamodelObjects.USER_ID, interview.getUserId())
    ...
    public InterviewSessionDto loadInterview(Long interviewId) {
        CosmicDatamodelRecord row = gateway.load(CareerLoopDatamodelObjects.INTERVIEW, interviewId);
        if (row == null) {
    ...
    public List<InterviewSessionDto> listByUser(final String userId) {
        List<CosmicDatamodelRecord> rows = gateway.list(CareerLoopDatamodelObjects.INTERVIEW, new CosmicRecordFilter() {
    ...
    public void deleteInterview(Long interviewId) {
        gateway.delete(CareerLoopDatamodelObjects.INTERVIEW, interviewId);
    ...
    public InterviewMessageDto saveMessage(InterviewMessageDto message) {
        CosmicDatamodelRecord row = message.getMessageId() == null ? null
                : gateway.load(CareerLoopDatamodelObjects.INTERVIEW_MESSAGE, message.getMessageId());
        if (row == null) {
            row = new CosmicDatamodelRecord(CareerLoopDatamodelObjects.INTERVIEW_MESSAGE);
        }
    ...
    public List<InterviewMessageDto> listMessages(final Long interviewId) {
        List<CosmicDatamodelRecord> rows = gateway.list(CareerLoopDatamodelObjects.INTERVIEW_MESSAGE, new CosmicRecordFilter() {
            public boolean matches(CosmicDatamodelRecord record) {
    ...
    public void deleteMessages(final Long interviewId) {
        gateway.deleteWhere(CareerLoopDatamodelObjects.INTERVIEW_MESSAGE, new CosmicRecordFilter() {
            public boolean matches(CosmicDatamodelRecord record) {
                return DatamodelFieldMapper.same(interviewId, record.get("interview_id"));
            }
        });
    ...
    private InterviewSessionDto toInterview(CosmicDatamodelRecord row) {
        ...
        dto.setInterviewId(DatamodelFieldMapper.asLong(row.get(CareerLoopDatamodelObjects.ID)));
    ...
    private InterviewMessageDto toMessage(CosmicDatamodelRecord row) {
        ...
        dto.setMessageId(DatamodelFieldMapper.asLong(row.get(CareerLoopDatamodelObjects.ID)));
