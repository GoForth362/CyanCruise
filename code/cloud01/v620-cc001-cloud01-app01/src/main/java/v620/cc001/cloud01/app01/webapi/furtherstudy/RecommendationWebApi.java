...
public class RecommendationWebApi {
    ...
    public RecommendationWebApi() {
        this(new RecommendationApplicationService(), new IdentityAwareCyanCruiseWebApiBoundary());
    }

    public RecommendationWebApi(RecommendationApplicationService applicationService,
