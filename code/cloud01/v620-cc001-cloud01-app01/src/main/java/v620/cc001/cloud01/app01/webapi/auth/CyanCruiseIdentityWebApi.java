 ...
 */
@ApiController(value = "cyanCruiseIdentityWebApi", desc = "CyanCruise 身份 API")
@ApiMapping("/cc001/identity")
public class CyanCruiseIdentityWebApi {

    private final IdentityAwareCyanCruiseWebApiBoundary identityBoundary;

    public CyanCruiseIdentityWebApi() {
        this(new IdentityAwareCyanCruiseWebApiBoundary());
    }

    public CyanCruiseIdentityWebApi(IdentityAwareCyanCruiseWebApiBoundary identityBoundary) {
